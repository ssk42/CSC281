...
public class LinkedList<Item> implements List<Item> {
    ...
    /**
     * Returns the number of elements in this list.  If this list contains more than <tt>Integer.MAX_VALUE</tt>
    ...
    public boolean contains(Object o) {
        ...
        Item other = (Item) o; // throws ClassCastException if not valid
     ...
     *
     * @param array the array into which the elements of this list are to be stored, if it is big enough; otherwise, a
    ...
    public <T> T[] toArray(T[] array) {
        ...
        for (int i = 0; i < array.length; i++) {
            //noinspection unchecked
            array[i] = (T) current.data; // will throw an ArrayStoreException if not valid
            current = current.next;
        }
    ...
    public boolean add(Item item) {
        ...
        listItem.data = item;
        // already have listItem.next = null;
    ...
    public boolean remove(Object o) {
        ...
        @SuppressWarnings("unchecked")
        Item other = (Item) o; // may throw ClassCastException
    ...
    public boolean addAll(Collection<? extends Item> c) {
        ...
        ListItem newTop = null, current = null;
        int index = 0;
        for (Item item : c) {
            ListItem listItem = new ListItem();
            listItem.data = (Item) c;
            if (index == 0) {
                newTop = listItem;
                current = listItem;
            } else {
    ...
    public boolean addAll(int index, Collection<? extends Item> c) {
        ...
        ListItem newTop = null, current = null, newTail = null;
        int i = 0;
        for (Item item : c) {
            ListItem listItem = new ListItem();
            listItem.data = (Item) c;
        ...
        if (head == null) { // hence size()==0
            head = newTop;
        } else {
            ListItem pointAtIndex = head;
            while (pointAtIndex.next != null) pointAtIndex = pointAtIndex.next;
            ListItem pointAfterThat = pointAtIndex.next;
            pointAtIndex.next = newTop;
            newTail.next = pointAfterThat;
        }
    ...
    public boolean removeAll(Collection<?> c) {
        ...
        for(Object item : c) altered |= this.remove(item);
